...
import { getDefaultImage, getProfileImage } from "../util/get-images";
...
const TopUsers = ({ users }) => {
  ...
  return (
    <div className="w-full mx-auto select-none px-4 sm:px-8 md:px-12 lg:px-20">
      <h2
        onClick={toggleOpen}
        className="cursor-pointer text-xl text-green-800 mb-4 text-left font-alien"
      >
        * 이주의 멋진 외계인 ᕙ༼◕ ᴥ ◕༽ᕗ
      </h2>
          ...
          {Array.from({ length: 3 }).map((_, idx) => {
            ...
            return user ? (
              ...
              >
                ...
                <div className="mb-4 font-alien text-base text-gray-800">
              ...
              <div
                key={`empty-${idx}`}
                className="bg-gray-100 p-4 flex flex-col items-center justify-center text-center text-gray-500 round-box-border"
              >
                <p className="text-base font-semibold">다음은 너? ヽ(•̀ω•́ )ゝ</p>
              </div>
            );
          })}
        </div>
