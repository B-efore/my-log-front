...
const Fortune = () => {
    ...
    return (
        <div className="h-screen overflow-hidden">
            <Header />
            <div className="flex flex-col bg-[url('/8269622.jpg')] bg-cover bg-center items-center justify-center h-[calc(100vh)] pt-14 px-14 select-none">
                {loading ? (
                    ...
                    <div className="bg-black p-8 max-h-[60vh] w-4/5 sm:w-3/4 md:w-3/5 lg:min-w-2/5 overflow-auto">
                        <div className="text-white text-md font-alien whitespace-pre-wrap">
                            {fortune}
                        </div>
                    </div>
                )}
